<?php
class Extended_Group_Control_Typography extends \Elementor\Group_Control_Typography {
    ...
    protected function init_fields() {
        ...
        $new_field = [
            'font-feature-settings' => [
                'label' => esc_html_x('اعداد فارسی', 'Typography Control', 'elementor'),
                ...
                'return_value' => '"numr"',
				'condition' => [
                    'font_family' => ['Estedad','Gandom','IRANYekanX','Kara','Mikhak','Nahid','Parastoo','Sahel','Samim','Shabnam','Tanha','VazirMatn',]
					],
            ]
        ];
...
add_action('elementor/controls/register', function($controls_manager) {
    $controls_manager->add_group_control(Extended_Group_Control_Typography::get_type(), new Extended_Group_Control_Typography());
});