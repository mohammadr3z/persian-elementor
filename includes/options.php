    ...
    <div class="wrap">
        ...
        <div class="about-wrap" style="max-width:100%!important">
            <div style="display:flex; align-items:center; justify-content:center; margin-bottom:20px;">
                <img src="<?php echo esc_url(plugins_url('persian-elementor/assets/images/about.png')) ?>" alt="Persian Elementor Logo" style="max-width:100px; margin-left:20px; background-color:#ffbc7d">
