...
function persian_elementor_settings_page(): void {
    ...
    $fields = [
        ...
        'efa-flatpickr' => [
            'label' => 'تقویم شمسی',
            'desc' => 'با فعال کردن این گزینه، تقویم شمسی به فیلد تاریخ فرم المنتور اضافه خواهد شد.',
        ],
        'efa-iranian-icon' => [
    ...
    <div class="wrap">
        ...
        <div class="about-wrap" style="max-width:100%!important">
            <div style="display:flex; align-items:center; justify-content:center; margin-bottom:20px;">
            	<img  src="<?= esc_url(plugins_url('persian-elementor/assets/images/about.png')) ?>" alt="Persian Elementor Logo" style="max-width:100px; margin-left:20px; background-color:#93033C">
            ...
            <p style="text-align:center!important">لطفاً تغییرات خود را انجام دهید و پس از اتمام، دکمه "ذخیره تنظیمات" را فشار دهید تا تنظیمات ذخیره شوند.</p>
        </div>
        
        <form method="post" action="options.php">
            <?php
            settings_fields('persian_elementor_group');
            do_settings_sections('persian_elementor');
            ?>
            <table class="form-table" style="background-color: #fff; color: rgba(0, 0, 0, 0.87); transition: box-shadow 300ms cubic-bezier(0.4, 0, 0.2, 1) 0ms; border-radius: 4px; box-shadow: none; display: flex; justify-content: space-between; padding: 24px 32px;">
                <?php foreach ($fields as $key => $field) : ?>
                    <tr valign="top">
                        ...
                        <td>
                            <input type="checkbox" name="persian_elementor[<?= esc_attr($key) ?>]" value="1" <?php checked(1, $options[$key] ?? 0) ?> />
